...
uint8   Switch_init(void)
{
    ...
    if (temp == DEVICEID)
    {
        ...
        UartSendString(sciREG1," SJA1105 DeviceID :  \0");
        UartSendHexU32(sciREG1,temp);
    ...
    {
#if (DEBUG)
        UartSendString(sciREG1," SJA1105 Part_NR : \0");
        UartSendHexU32(sciREG1,temp);
        UartSendString(sciREG1,"\r\n\0");
#endif
...
*/
    ...
    {
#if (DEBUG)
        UartSendString(sciREG1," SJA1105 init Success ,stauts regs is : 0x80000000   \r\n\0");
#endif
        return 1;
    }
    else
    {
#if (DEBUG)
        UartSendString(sciREG1," SJA1105 init is fail!  \r\n\0");
#endif
        return 0;
    }
}
