...
void FreeRTOS_set_time_ntp(time_t *pulSeconds, time_t *pulMsec);
void FreeRTOS_set_time_gps(time_t *pulSeconds, time_t *pulMsec);
void FreeRTOS_set_time_ptp(time_t *pulSeconds, time_t *pulMsec);

void   FreeRTOS_set_time_rtc(time_t *pulSeconds);
time_t FreeRTOS_get_time_rtc();
