...
#define ipconfigUSE_DDS                     ( 0 )
#define ipconfigUSE_RTC                     ( 0 )
...
/*PTP*/
#define ipconfigUSE_PTP                     ( 1 )
#define ipconfigUSE_GPS                     ( 1 )
#define ipconfigUSE_NTP                     ( 0 )
#define ipconfigUSE_CALLBACKS				( 1 )
#define ipconfigNTP_REQUEST_ATTEMPTS        ( 5 )
...
#define ipconfigETHERNET_DRIVER_RX_FLOW_CONTROLL	(0)
